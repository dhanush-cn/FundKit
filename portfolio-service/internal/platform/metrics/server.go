...
//
//   - portfolio-service speaks gRPC to its peers while Prometheus speaks HTTP,
//     so it needs an HTTP listener anyway; giving metrics their own keeps the
//     probe mux answering kubelet even while a scrape is in flight;
