...
//
// In this service the type does one extra job. A valuation multiplies an
// integer amount by a fractional unit count, so there is exactly one place
// where a float enters the arithmetic and exactly one rounding — see
// Holding.Value.
//
