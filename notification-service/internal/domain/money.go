...
//
// This service keeps its own copy of the type rather than sharing a module,
// which is the same deliberate choice it already makes for the event schema: a
// consumer owns the shape it can tolerate. The copy is what lets this service
// hold the unit it understands independently of what the producer ships next.
//
