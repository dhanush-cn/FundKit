...
//
//   - the public router carries the request timeout, tracing and access-log
//     chain that exists for customer traffic; a scrape is not customer traffic
//     and should not be measured, logged or timed out as if it were;
